...
public class RegisterTest {
    ...
    void calculateCurrentTotalWorks() {
        ...
        Product fridge = new Product("123456", "fridgy", 2000, new ProductType("appliance"));
        Product boat = new Product("123457", "boaty", 3000, new ProductType("vehicle"));
        Product cow = new Product("123458", "mooey", 6000, new ProductType("animal"));
