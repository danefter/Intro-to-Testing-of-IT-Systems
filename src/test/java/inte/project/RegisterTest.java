...
public class RegisterTest {
    ...
    void calculateCurrentTotalWorks() {
        ...
        Product fridge = new Appliances("123456", "fridgy", new Money(2000));
        Product boat = new HouseHold("123457", "boaty", new Money(3000));
        Product cow = new Tele("123458", "mooey", new Money(6000));
